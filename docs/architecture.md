...
**Custom Wazuh rules:** Wazuh's built-in auditd rule 80700 suppresses all audit events at level 0. Custom child rules (210100-210114) were written to match specific audit keys and generate actionable alerts. See [custom-rules.md](custom-rules.md).
